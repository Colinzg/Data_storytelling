...
(function () {
    ...
    class CharacterAnimator {
        ...
        _simpleSwitch(targetImg) {
            ...
            setTimeout(function () {
                ...
                self.imgEl.style.transform = 'scale(1)';
            }, 120);
        }
    ...
    function ensureGlobalWheel() {
        ...
        window.addEventListener('touchend', function(e) {
            ...
            const deltaY = touchStartY - (e.changedTouches[0] ? e.changedTouches[0].clientY : touchStartY);

            if (deltaY > TOUCH_THRESHOLD && !active.framesExhausted) {
                e.preventDefault();
                active.nextFrame();
            } else if (deltaY < -TOUCH_THRESHOLD && !active.atFirstFrame) {
                e.preventDefault();
                active.prevFrame();
            }
        }, { passive: false });
